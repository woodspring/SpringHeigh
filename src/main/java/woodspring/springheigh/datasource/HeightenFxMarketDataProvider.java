...
public class HeightenFxMarketDataProvider {
	...
	private static ConcurrentHashMap<String, FxForwardPoint> fxFwdPointCache; 
	private static ConcurrentSkipListMap< String, FxSpotRate> fxSpotRateCache;
	
	
	
	private static List<Fx> grepSwapPointsAndSpotRate(String symbol,  HtmlUnitDriver unitDriver) throws FileNotFoundException, InterruptedException {
